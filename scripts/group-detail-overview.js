...
const initGroupOverview = () => {
  ...
  const groups = [
    ...
    { slug: 'cras', name: 'Les Crâs', image: 'cras/cras-carte.webp' },
    { slug: 'ecaflips', name: 'Les Écaflips', image: 'ecaflips/ecaflips-carte.webp' },
    { slug: 'dragons', name: 'Les Dragons', image: 'dragons/dragons-carte.webp' },
    ...
    { slug: 'eniripsas', name: 'Les Éniripsas', image: 'eniripsas/eniripsas-carte.webp' },
    { slug: 'enutrofs', name: 'Les Énutrofs', image: 'enutrofs/enutrofs-carte.webp' },
    { slug: 'fecas', name: 'Les Fécas', image: 'fecas/fecas-carte.webp' },
    { slug: 'fratrie-des-oublies', name: 'La Fratrie des Oubliés', image: 'fratrie-des-oublies/fratrie-des-oublies-carte.webp' },
    { slug: 'forgelances', name: 'Les Forgelances', image: 'forgelances/forgelances-carte.webp' },
    { slug: 'gardiens-des-mois', name: 'Les Gardiens des Mois', image: 'gardiens-des-mois/gardiens-des-mois-carte.webp' },
    { slug: 'guilde-des-murmures', name: 'La Guilde des Murmures', image: 'guilde-des-murmures/guilde-des-murmures-carte.webp' },
    { slug: 'huppermages', name: 'Les Huppermages', image: 'huppermages/huppermages-carte.webp' },
    { slug: 'iops', name: 'Les Iops', image: 'iops/iops-carte.webp' },
    { slug: 'ouginaks', name: 'Les Ouginaks', image: 'ouginaks/ouginaks-carte.webp' },
    { slug: 'osamodas', name: 'Les Osamodas', image: 'osamodas/osamodas-carte.webp' },
    { slug: 'pandawas', name: 'Les Pandawas', image: 'pandawas/pandawas-carte.webp' },
    ...
    { slug: 'necromes', name: 'Les Nécromes', image: 'necromes/necromes-carte.webp' },
    { slug: 'roublards', name: 'Les Roublards', image: 'roublards/roublards-carte.webp' },
    { slug: 'sacrieurs', name: 'Les Sacrieurs', image: 'sacrieurs/sacrieurs-carte.webp' },
    { slug: 'sadidas', name: 'Les Sadidas', image: 'sadidas/sadidas-carte.webp' },
    { slug: 'shushus', name: 'Les Shushus', image: 'shushus/shushus-carte.webp' },
    { slug: 'srams', name: 'Les Srams', image: 'srams/srams-carte.webp' },
    { slug: 'steamers', name: 'Les Steamers', image: 'steamers/steamers-carte.webp' },
    { slug: 'voyageurs-dimensionnels', name: 'Les Voyageurs Dimensionnels', image: 'voyageurs-dimensionnels/voyageurs-dimensionnels-carte.webp' },
    { slug: 'xelors', name: 'Les Xélors', image: 'xelors/xelors-carte.jpg' },
    { slug: 'zobals', name: 'Les Zobals', image: 'zobals/zobals-carte.webp' },
