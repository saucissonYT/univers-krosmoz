...
(function () {
  ...
  function createLinkedName(name) {
    ...
    link.href = `../media-html/arbre-affinites.html?personnage=${encodeURIComponent(name)}`;
  ...
  function initCharacterAffinities() {
    ...
    treeLink.href = `../media-html/arbre-affinites.html?personnage=${encodeURIComponent(characterName)}`;
