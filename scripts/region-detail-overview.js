...
const initRegionOverview = () => {
  ...
  const regions = [
    ...
    { slug: 'bibliotemple', name: 'Bibliotemple', image: 'bibliotemple/bibliotemple.png' },
    ...
    { slug: 'pandala', name: 'Pandala', image: 'pandala/pandala.png' },
    ...
    { slug: 'ile-otomai', name: "Île d'Otomaï", image: 'ile-otomai/ile-otomai.png' },
    { slug: 'nimotopia', name: 'Nimotopia', image: 'nimotopia/nimotopia.webp' },
    { slug: 'saharach', name: 'Saharach', image: 'saharach/saharach.png' },
